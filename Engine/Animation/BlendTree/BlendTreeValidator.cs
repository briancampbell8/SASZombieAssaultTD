    ...
    public static class BlendTreeValidator
    {
        ...
        public static BlendTreeValidationReport ValidateBlendTree(BlendTree blendTree)
        {
            ...
            try
            {
                ...
                DLogger.Log(LogSubsystems.Animation, LogLevel.Debug, $"BlendTreeValidator: Starting validation for blend tree '{blendTree.TreeId}'");
                ...
                DLogger.Log(LogSubsystems.Animation, LogLevel.Debug, $"BlendTreeValidator: Validation completed for '{blendTree.TreeId}' - " +
            ...
            {
                DLogger.Log(LogSubsystems.Animation, LogLevel.Error, $"BlendTreeValidator: Exception during validation: {ex.Message}");
