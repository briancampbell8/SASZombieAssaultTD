...
namespace SASZombieAssaultTD.Engine.Animation.Core
{
    ...
    public sealed class AnimationClip
    {
        ...
        public void AddTrack(AnimationTrack track)
        {
            ...
            DLogger.Log(LogSubsystems.Animation, LogLevel.Debug, $"AnimationClip '{Name}': Added track '{track.Name}' of type {track.Type}");
        }
    ...
    public sealed class AnimationClipFrame
    {
        ...
        public AnimationClipFrame(float time, float duration, int spriteIndex = 0)
        {
            ...
            DLogger.Log(LogSubsystems.Animation, LogLevel.Debug, $"AnimationFrame: Created at time {time:F3}, duration {duration:F3}s");
        }
