// ====================================================================================================
//  FILE: MoveState.cs
//  PATH: Engine/Animation/Core/State/MoveState.cs
//  SUBSYSTEM: Animation Core State
//
//  ROLE:
//      Encapsulate core engine behavior for the MoveState module.
//
//  RESPONSIBILITIES:
...
//
{
    ...
    public class MoveState : IAnimationState
    {
        ...
        ///<summary>
        ///P11-17-04: Movement threshold for determining if ECSEntityCore is actually moving.
        ...
        {
            MoveTime = 0f;
            DLogger.Log(LogSubsystems.Animation, LogEnums.LogLevel.Debug, $"MoveState: Entering move state with speed {MovementSpeed:F2}");
        }
        ...
        public void Exit()
        {
            DLogger.Log(LogSubsystems.Animation, LogEnums.LogLevel.Debug, $"MoveState: Exiting move state after {MoveTime:F2}s");
        }
        ...
        public IAnimationState? CheckTransitions()
        {
            ...
            if (IsJumping)
            {
                DLogger.Log(LogSubsystems.Animation, LogEnums.LogLevel.Debug, "MoveState: Transition condition met for JumpState");
                return _jumpState;
            }

            if (IsAttacking)
            {
                DLogger.Log(LogSubsystems.Animation, LogEnums.LogLevel.Debug, "MoveState: Transition condition met for AttackState");
                return _attackState;
            }
            ...
            if (!IsMoving)
            {
                DLogger.Log(LogSubsystems.Animation, LogEnums.LogLevel.Debug, "MoveState: Transition condition met for IdleState (movement stopped)");
                return _idleState;
            }
