...
//  Path:    Engine/Animation/Transitions/AnimationTransition.cs
...
namespace SASZombieAssaultTD.Engine.Animation.Core.Transitions
{
    ...
    public class AnimationTransition
    {
        ...
        public AnimationTransition(object targetState) => TargetState = targetState ?? throw new System.ArgumentNullException(nameof(targetState));
