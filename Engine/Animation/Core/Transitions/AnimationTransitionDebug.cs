...
//  Path:    Engine/Animation/Core/Transitions/AnimationTransitionDebug.cs
...
{
    /// <summary>
    /// Animation transition debugging and visualization system. Implements P11-16-05: Animation transition debugging
    /// and visualization.
    /// </summary>
    public class AnimationTransitionDebug
    {
        ...
        private readonly int _ECSEntityCoreId;
        ...
        /// <summary>
        /// Gets the ECSEntityCore ID being debugged.
        /// </summary>
        ...
        /// </summary>
        /// <param name="ECSEntityCoreId">The ECSEntityCore ID.</param>
        ...
        public AnimationTransitionDebug(int ECSEntityCoreId, string fromState, string toState, Vector3 startPosition, Vector3 endPosition, float duration)
        {
