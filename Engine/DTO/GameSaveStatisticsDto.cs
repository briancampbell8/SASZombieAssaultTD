// =====================================================================================================
//  FILE: GameSaveStatisticsDto.cs
//  PATH: Engine/DTO/GameSaveStatisticsDto.cs
//  SUBSYSTEM: Engine DTO
//
//  ROLE:
//      Serialized data container representing aggregated gameplay statistics. Used by
//      GameSaveLoadService and GameSaveWriteService during deterministic save/load operations.
//
//  RESPONSIBILITIES:
//      - Provide pure field-based data for kill counts, wave completions, and other tracked metrics.
//      - Maintain strict separation from engine runtime logic and subsystem execution.
//      - Serve as the statistics-specific component of the root GameSaveDto.
//
...
public sealed class GameSaveStatisticsDto
{
