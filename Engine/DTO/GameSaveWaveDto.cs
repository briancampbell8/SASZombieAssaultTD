// =====================================================================================================
//  FILE: GameSaveWaveDto.cs
//  PATH: Engine/DTO/GameSaveWaveDto.cs
//  SUBSYSTEM: Engine DTO
//
//  ROLE:
//      Serialized data container representing the current wave’s save-state. Used by
//      GameSaveLoadService and GameSaveWriteService during deterministic save/load operations.
//
//  RESPONSIBILITIES:
//      - Provide pure field-based data for wave index, spawn counts, remaining enemies,
//        and timing information.
//      - Maintain strict separation from engine runtime logic and subsystem execution.
//      - Serve as the wave-specific component of the root GameSaveDto.
//
...
public sealed class GameSaveWaveDto
{
    public int CurrentWave;
    public int EnemiesRemaining;
    public int EnemiesSpawned;
    public int WaveStartFrame;
