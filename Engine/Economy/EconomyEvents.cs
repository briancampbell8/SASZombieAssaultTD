...
//
//  ROLE:
//      Encapsulate core engine behavior for the EconomyEvents module.
//
//  RESPONSIBILITIES:
//      - Provide TriggerCashChanged() behavior for the Core subsystem.
//      - Provide TriggerPurchaseAttempted() behavior for the Core subsystem.
//      - Provide TriggerPurchaseCompleted() behavior for the Core subsystem.
//      - Provide TriggerEconomyStateChanged() behavior for the Core subsystem.
//      - Provide TriggerTransactionCompleted() behavior for the Core subsystem.
//      - Provide ClearAllEvents() behavior for the Core subsystem.
//
...
//
{
    ...
    /// <summary>
    /// Central event manager for economy-related events. Provides loose coupling between economy systems and UI/other
    /// systems.
    /// </summary>
    public static class EconomyEvents
    {
        ...
        public static void TriggerCashChanged(int oldAmount, int newAmount, string source)
        {
            ...
            DLogger.Log(LogSubsystems.Economy, "INFO", $"EconomyEvents: Cash changed from {oldAmount} to {newAmount} via {source}");
        }
        ...
        public static void TriggerPurchaseAttempted(string itemId, string itemName, int cost)
        {
            ...
            DLogger.Log(LogSubsystems.Economy, "INFO", $"EconomyEvents: Purchase attempted - {itemName} ({cost})");
        }
        ...
        public static void TriggerPurchaseCompleted(string itemId, string itemName, int cost, bool isSuccessful, string errorMessage = "")
        {
            ...
            DLogger.Log(LogSubsystems.Economy, "INFO", $"EconomyEvents: Purchase {(isSuccessful ? "completed" : "failed")} - {itemName} ({cost})");
        }
        ...
        public static void TriggerEconomyStateChanged(string stateName, Dictionary<string, object> stateData = null)
        {
            ...
            DLogger.Log(LogSubsystems.Economy, "INFO", $"EconomyEvents: State changed to {stateName}");
        }
        ...
        public static void TriggerTransactionCompleted(Transaction transaction)
        {
            ...
            DLogger.Log(LogSubsystems.Economy, "INFO", $"EconomyEvents: Transaction completed - {transaction}");
        }
        ...
        public static void ClearAllEvents()
        {
            ...
            DLogger.Log(LogSubsystems.Economy, "INFO", "EconomyEvents: All events cleared");
        }
    }
}
