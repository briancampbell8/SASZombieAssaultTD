...
namespace SASZombieAssaultTD.Engine.GameRoot.GamePlay
{
    ...
    public class BattlefieldFlowManager
    {
        ...
        public BattlefieldFlowManager()
        {
            ...
            DLogger.Log(LogSubsystems.Gameplay, LogEnums.LogLevel.Info, "INFO", "BattlefieldFlowManager: Initialized");
        }
        ...
        public void SetSceneManager(SceneManager sceneManager)
        {
            ...
            DLogger.Log(LogSubsystems.Gameplay, LogEnums.LogLevel.Info, "INFO", "BattlefieldFlowManager: SceneManager set");
        }
        ...
        public bool SelectBattlefield(BattlefieldType battlefield)
        {
            ...
            DLogger.Log(LogSubsystems.Gameplay, LogEnums.LogLevel.Info, "INFO", $"BattlefieldFlowManager: Selected {battlefield.GetDisplayName()}");
        ...
        public bool LoadBattlefield(Action<float>? progressCallback = null)
        {
            ...
            {
                DLogger.Log(LogSubsystems.Gameplay, LogEnums.LogLevel.Info, "ERROR", "BattlefieldFlowManager: Cannot load - no battlefield selected");
                return false;
            }

            if (_isLoading)
            {
                DLogger.Log(LogSubsystems.Gameplay, LogEnums.LogLevel.Info, "Warning", "BattlefieldFlowManager: Cannot load - already loading");
                return false;
            }

            if (_sceneManager == null)
            {
                DLogger.Log(LogSubsystems.Gameplay, LogEnums.LogLevel.Info, "ERROR", "BattlefieldFlowManager: Cannot load - SceneManager not set");
                return false;
            }
            ...
            DLogger.Log(LogSubsystems.Gameplay, LogEnums.LogLevel.Info, "INFO", $"BattlefieldFlowManager: Starting load for {_selectedBattlefield.Value.GetDisplayName()}");
        ...
        private void CompleteLoading()
        {
            ...
            var success = _sceneManager.SetScene("Gameplay");


            if (success)
            {
                DLogger.Log(LogSubsystems.Gameplay, LogEnums.LogLevel.Info, "INFO", $"BattlefieldFlowManager: Successfully loaded {_selectedBattlefield.Value.GetDisplayName()}");
                OnBattlefieldLoadingCompleted?.Invoke(_selectedBattlefield.Value);
            }
            else
            {
                DLogger.Log(LogSubsystems.Gameplay, LogEnums.LogLevel.Info,
        ...
        public void UnlockBattlefield(BattlefieldType battlefield)
        {
            ...
            DLogger.Log(LogSubsystems.Gameplay, LogEnums.LogLevel.Info, "INFO", $"BattlefieldFlowManager: Unlocked {battlefield.GetDisplayName()}");
        ...
        public void CompleteBattlefield(BattlefieldType battlefield)
        {
            ...
            DLogger.Log(LogSubsystems.Gameplay, LogEnums.LogLevel.Info, "INFO", $"BattlefieldFlowManager: Completed {battlefield.GetDisplayName()}");
        ...
        public void ResetProgress()
        {
            ...
            DLogger.Log(LogSubsystems.Gameplay, LogEnums.LogLevel.Info, "INFO", "BattlefieldFlowManager: Reset all progress");
        }
