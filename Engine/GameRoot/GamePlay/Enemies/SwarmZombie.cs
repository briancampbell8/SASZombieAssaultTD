...
//
//  ROLE:
//      Encapsulate core engine behavior for the SwarmZombie module.
//
//  RESPONSIBILITIES:
...
Purpose: Fast, weak enemy that appears in groups.
         Defines idECSEntityCore, category, and placeholder behavior for swarm-type enemies.
...
namespace SASZombieAssaultTD.Engine.GameRoot.GamePlay.Enemies
{
    ...
    public class SwarmZombie
    {
        ...
        ///</summary>
        public SwarmZombie() => Id = GenerateId();

        ///<summary>
        ///Creates a new swarm zombie instance with specified ID.
        ///</summary>
        ///<param name="id">Unique identifier.</param>
        public SwarmZombie(string id) => Id = id ?? GenerateId();
