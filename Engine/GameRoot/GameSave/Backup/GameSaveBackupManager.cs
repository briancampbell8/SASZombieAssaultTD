// =====================================================================================================
//  FILE: GameSaveBackupManager.cs
//  PATH: Engine/GameRoot/GameSave/Backup/GameSaveBackupManager.cs
//  SUBSYSTEM: GameRoot GameSave Backup Subsystems
//
//  ROLE:
...
namespace SASZombieAssaultTD.Engine.GameRoot.GameSave.Backup
{
    internal class GameSaveBackupManager
    {
        // Creates a backup of the serialized save data.
        public void CreateBackup(string saveId, string serializedData)
        {
        }

        // Restores a backup and returns the serialized save data.
        public string RestoreBackup(string saveId)
        {
            return string.Empty;
        }

        // Deletes an existing backup.
        public void DeleteBackup(string saveId)
        {
        }

        // Checks whether a backup exists.
        public bool BackupExists(string saveId)
        {
            return false;
        }
    }
