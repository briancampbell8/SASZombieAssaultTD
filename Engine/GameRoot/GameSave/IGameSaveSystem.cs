// =====================================================================================================
//  FILE: IGameSaveSystem.cs
//  PATH: Engine/GameRoot/GameSave/IGameSaveSystem.cs
...
// =====================================================================================================
namespace SASZombieAssaultTD.Engine.GameRoot.GameSave
{
    internal interface IGameSaveSystem
    {
    }
}
