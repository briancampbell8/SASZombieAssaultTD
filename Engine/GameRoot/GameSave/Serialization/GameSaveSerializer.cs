// =====================================================================================================
//  FILE: GameSaveSerializer.cs
//  PATH: Engine/GameRoot/GameSave/Serialization/GameSaveSerializer.cs
//  SUBSYSTEM: GameRoot GameSave Serialization Subsystems
//
//  ROLE:
...
namespace SASZombieAssaultTD.Engine.GameRoot.GameSave.Serialization
{
    internal class GameSaveSerializer
    {
    }
}
