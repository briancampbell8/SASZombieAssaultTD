// =====================================================================================================
//  FILE: StateRuntimeState.cs
//  PATH: Engine/GameRoot/GameSave/Subsystems/RuntimeStates/StateRuntimeState.cs
//  SUBSYSTEM: GameRoot GameSave Subsystems RuntimeStates
//
//  ROLE:
//      Provides a deterministic, immutable snapshot of high-level game state values as produced
//      by StateSubsystem during active gameplay. This class contains no lifecycle logic and is
...
//
//  RESPONSIBILITIES:
//      - Represent the final global game state values in a deterministic structure.
...
{
    internal sealed class StateRuntimeState
    {
        ...
        public StateRuntimeState(int currentLevel, bool isPaused, int currentFrame)
        {
