// =====================================================================================================
//  FILE: EnemyRuntimeSummary.cs
//  PATH: Engine/GameRoot/GameSave/Subsystems/EnemyRuntimeSummary.cs
...
{
    public class EnemyRuntimeSummary
    {
        public int TotalSpawned { get; }
        public int TotalKilled { get; }
        public object Value { get; }
        // Runtime-only summary container.

        public EnemyRuntimeSummary(int totalSpawned, int totalKilled, object value)
        {
