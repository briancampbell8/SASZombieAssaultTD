// =====================================================================================================
//  FILE: GameSaveValidator.cs
//  PATH: Engine/GameRoot/GameSave/Validation/GameSaveValidator.cs
//  SUBSYSTEM: GameRoot GameSave Validation Subsystems
//
//  ROLE:
...
namespace SASZombieAssaultTD.Engine.GameRoot.GameSave.Validation
{
    internal class GameSaveValidator
    {
    }
}
