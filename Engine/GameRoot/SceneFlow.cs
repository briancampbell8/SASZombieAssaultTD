...
namespace SASZombieAssaultTD.Engine
{
    ...
    public partial class GameRoot
    {
        ...
        public GameRoot(SystemManager systemManager, UpdateManager updateManager, RenderManager renderManager)
        {
            _systemManager = systemManager;
            _updateManager = updateManager;
            _renderManager = renderManager;
        ...
        public static object RenderContext { get; internal set; }
        ...
        private SceneManager? GetSceneManager()
        {
            ...
            {
                Dlogger.Log(LogSubsystems.GameRoot, LogLevel.Error, $"Failed to retrieve SceneManager: {ex.Message}");
                Dlogger.Log(ex, "SceneManager retrieval");
                return null;
            }
        }
        ...
        public bool SwitchToScene(string sceneName)
        {
            ...
            {
                Dlogger.Log(LogSubsystems.GameRoot, LogLevel.Error, "Cannot switch scene - SceneManager not available");
                return false;
            }
        ...
        public BaseScene? LoadScene(string sceneName)
        {
            ...
            if (sceneManager == null)
            {
                Dlogger.Log(LogSubsystems.GameRoot, LogLevel.Error, "Cannot load scene - SceneManager not available");
                return null;
            }
        ...
        public bool UnloadScene(string sceneName)
        {
            ...
            if (sceneManager == null)
            {
                Dlogger.Log(LogSubsystems.GameRoot, LogLevel.Error, "Cannot unload scene - SceneManager not available");
                return false;
            }
