...
{
    ///<summary>
    ///Defines the contract for debug rendering visualization.
    ///Implements P11-16-05: Debug rendering visualization for animation and system debugging.
    ///</summary>
    public interface IDebugRenderer
    {
        ...
        void DrawLines(IEnumerable<(Vector3 start, Vector3 end, System.Drawing.Color color, float thickness)> lines);
        ...
        void DrawLine(Vector3 start, Vector3 end, System.Drawing.Color color, float thickness = 1.0f);
        ...
        void DrawPoints(IEnumerable<(Vector3 position, System.Drawing.Color color, float size)> points);
        ...
        void DrawPoint(Vector3 position, System.Drawing.Color color, float size = 1.0f);

        ///<summary>
        ///Draws a sphere at specified position with radius and color.
        ///Used for state indicators and collision visualization.
        ///</summary>
        ///<param name="center">The center position of the sphere.</param>
        ///<param name="radius">The radius of the sphere.</param>
        ///<param name="color">The color of the sphere.</param>
        void DrawSphere(Vector3 center, float radius, System.Drawing.Color color);

        ///<summary>
        ///Draws a box at specified position with size and color.
        ///Used for bounding box visualization and debug containers.
        ///</summary>
        ///<param name="center">The center position of the box.</param>
        ///<param name="size">The size of the box.</param>
        ///<param name="color">The color of the box.</param>
        void DrawBox(Vector3 center, Vector3 size, System.Drawing.Color color);

        ///<summary>
        ///Draws a circle at specified position with radius and color.
        ///Used for range indicators and circular visualization.
        ///</summary>
        ///<param name="center">The center position of the circle.</param>
        ///<param name="radius">The radius of the circle.</param>
        ///<param name="color">The color of the circle.</param>
        void DrawCircle(Vector3 center, float radius, System.Drawing.Color color);
        ...
        void DrawText(Vector3 position, string text, System.Drawing.Color color, int fontSize);

        ///<summary>
        ///Draws text at specified screen position with color and font size.
        ///Used for UI overlay debug information.
        ///</summary>
        ///<param name="position">The screen position to draw the text.</param>
        ///<param name="text">The text to draw.</param>
        ///<param name="color">The color of the text.</param>
        ///<param name="fontSize">The font size for the text.</param>
        void DrawScreenText(Vector3 position, string text, System.Drawing.Color color, int fontSize);

        ///<summary>
        ///Draws an arrow from start to end position with specified color and thickness.
        ///Used for direction indicators and vector visualization.
        ///</summary>
        ...
        void DrawArrow(Vector3 start, Vector3 end, System.Drawing.Color color, float thickness = 1.0f);

        ///<summary>
        ///Draws a wireframe mesh at specified position with rotation and scale.
        ///Used for mesh visualization and collision shape debugging.
        ///</summary>
        ...
        void DrawWireframeMesh(Vector3 position, Quaternion rotation, Vector3 scale, IMesh mesh, System.Drawing.Color color);

        ///<summary>
        ///Draws a frustum for camera visualization.
        ///Used for camera frustum debugging and culling visualization.
        ///</summary>
        ...
        ///<summary>
        ///Draws a grid at specified position with size and spacing.
        ///Used for spatial reference and level editing visualization.
        ///</summary>
        ...
        void DrawGrid(Vector3 position, Vector3 size, float spacing, System.Drawing.Color color);
