...
//
//  ROLE:
//      Encapsulate core engine behavior for the CapsuleShape module.
//
//  RESPONSIBILITIES:
...
//      - Provide GetTopHemisphereCenter() behavior for the Core subsystem.
//      - Provide GetBottomHemisphereCenter() behavior for the Core subsystem.
...
{
    /// <summary>
    /// P11-14-01: Capsule collision shape (circle with height). Perfect for elongated entities like characters,
    /// bullets, and projectiles. Pure data component with no logic.
    /// </summary>
    public sealed class CapsuleShape : CollisionShape
    {
        ...
        /// <summary>
        /// Gets or sets the height of the capsule's cylindrical middle section. Total height = Height + 2 * Radius.
        /// </summary>
        public float Height
        {
            get => _height;
        ...
        /// <summary>
        /// Gets the area of this capsule. Area = cylindrical area + 2 * hemispherical area
        /// </summary>
