...
//
//  ROLE:
//      Encapsulate core engine behavior for the CollisionEvent module.
//
//  RESPONSIBILITIES:
...
namespace SASZombieAssaultTD.Engine.Physics.Collision
{
    ...
    {
        ///<summary>
        ///The first ECSEntityCore in the collision.
        ///</summary>
        public readonly ECSEntityCore EntityA;

        ///<summary>
        ///The second ECSEntityCore in the collision.
        ///</summary>
        public readonly ECSEntityCore EntityB;
        ...
        ///</summary>
        public CollisionEvent(ECSEntityCore ECSEntityCoreA, ECSEntityCore ECSEntityCoreB, bool isTrigger, ContactInfo contactInfo)
        {
            EntityA = ECSEntityCoreA;
            EntityB = ECSEntityCoreB;
            IsTrigger = isTrigger;
        ...
        ///Published when an ECSEntityCore enters the trigger range of another ECSEntityCore.
        ///</summary>
        public readonly struct TriggerEnterEvent
        {
            ///<summary>
            ///The trigger ECSEntityCore that detected the entry.
            ///</summary>
            public readonly object SourceEntityId;

            ///<summary>
            ///The ECSEntityCore that entered the trigger range.
            ///</summary>
        ...
        ///Published when an ECSEntityCore exits the trigger range of another ECSEntityCore.
        ///</summary>
        public readonly struct TriggerExitEvent
        {
            ///<summary>
            ///The trigger ECSEntityCore that detected the exit.
            ///</summary>
            public readonly object SourceEntityId;

            ///<summary>
            ///The ECSEntityCore that exited the trigger range.
            ///</summary>
            public readonly object TargetEntityId;
        ...
        ///</summary>
        public CollisionEvent(ECSEntityCore ECSEntityCoreA, ECSEntityCore ECSEntityCoreB, bool isTrigger)
        {
            EntityA = ECSEntityCoreA;
            EntityB = ECSEntityCoreB;
            IsTrigger = isTrigger;
    ...
    public readonly struct ContactInfo : IEquatable<ContactInfo>
    {
        ...
        ///Normalized vector pointing from the first ECSEntityCore to the second.
        ///</summary>
