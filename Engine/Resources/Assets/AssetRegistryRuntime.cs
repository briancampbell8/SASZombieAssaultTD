...
{
    /// <summary>
    /// Static asset registry for managing game resources in SAS Zombie Assault TD. Provides centralized storage,
    /// retrieval, and enumeration functionality for game assets.
    /// </summary>
    /// <remarks>
    /// AssetRegistry serves as the primary storage mechanism for all game assets including: - Textures and sprites -
    /// Audio files and sound effects - 3D models and meshes - UI elements and fonts - Configuration data and scripts
    /// </remarks>
    /// <example>
    /// <code>
    ...
    {
        /// <summary>
        /// Internal dictionary storing all registered assets with their unique identifiers. Uses object type to allow
        /// storage of any asset type.
        /// </summary>
        private static readonly Dictionary<string, object> _assets = new();

        /// <summary>
        /// Registers an asset with a unique name identifier. Stores the asset in the internal dictionary for later
        /// retrieval.
        /// </summary>
        ...
        /// Thrown when name is null, empty, or contains only whitespace.
        /// </exception>
        ...
        /// <summary>
        /// Retrieves an asset by name and casts it to the requested type. Provides type-safe access to stored assets.
        /// </summary>
        ...
        /// <remarks>
        /// If the asset is not found, returns the default value for type T (null for reference types). If the asset
        /// cannot be cast to type T, an InvalidCastException will be thrown.
        /// </remarks>
        ...
        /// <summary>
        /// Returns a copy of all registered assets as a dictionary. Provides enumeration access to the complete asset
        /// collection.
        /// </summary>
        /// <returns>A new Dictionary containing all asset name-value pairs.</returns>
        /// <remarks>
        /// Returns a copy to prevent external modification of the internal asset storage. The returned dictionary can
        /// be safely modified without affecting the AssetRegistry.
        /// </remarks>
