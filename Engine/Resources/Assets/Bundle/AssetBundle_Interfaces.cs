...
//============================================================================
//File:        AssetBundle_Interfaces.cs
//Path:        E:\BDC\Projects\SASZombieAssaultTD\Engine\Resources\Assets\Bundle\AssetBundle_Interfaces.cs
...
//    including creation, loading, processing, validation, metadata extraction,
//    and factory construction. Provides the stable API surface for all bundle
//    operations within the Asset subsystem.
//
//Responsibilities:
//    • Provide stable contracts for bundle creation, loading, and processing.
...
//    • Serve as the authoritative interface layer for the AssetBundle subsystem.
//
//Architecture:
//    • Interfaces implemented by the following classes:
...
//    • AssetPipeline subsystem for bundle creation and optimization.
//    • AssetBundle subsystem for loading and metadata access.
