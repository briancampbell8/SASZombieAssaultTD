...
//    for the new Asset subsystem. Provides foundational lifecycle management,
//    path resolution, memory statistics, and safety guards used by all other
//    AssetManager partials.
//
//Responsibilities:
//    • Initialize the Asset subsystem using default or custom configuration.
//    • Manage the asset root directory and perform deterministic path resolution.
//    • Provide memory usage statistics for loaded assets.
//    • Enforce disposal safety and lifecycle correctness.
//    • Coordinate with loader, registry, pipeline, and validation partials.
//
//Architecture:
...
//        – AssetManager_Config.cs     — configuration and subsystem settings
//
//Integration Points:
//    • AssetBundle subsystem for packaged asset loading
