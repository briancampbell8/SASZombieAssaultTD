...
namespace SASZombieAssaultTD.Engine.Resources
{
    ...
    //
    // Purpose:
    //     Core implementation of the AssetBundle system. Provides the foundational
    //     structures, metadata tables, and lifecycle management required for loading,
    //     tracking, and disposing bundled assets.
    ...
    // Architecture:
    //     This class is implemented as a partial type. Related functionality is split
    //     across multiple files for clarity and maintainability:
    ...
    // Integration Points:
    //     - Used by AssetSystem for bundle loading and asset retrieval
    //     - Used by AssetManager for unified asset access
    //     - Used by AssetPipeline for bundle creation and processing
    // Performance Notes:
