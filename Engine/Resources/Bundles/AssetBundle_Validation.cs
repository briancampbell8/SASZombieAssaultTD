// ============================================================================
// File Path: Engine/Resources/Bundles/AssetBundle_Validation.cs
// File: AssetBundle_Validation.cs
// Program: AssetBundle (Validation)
// Subsystem: Bundles
//
// Purpose:
//     Implements validation, health checking, repair, and optimization logic
//     for AssetBundle instances. Ensures bundle integrity, correctness,
//     performance characteristics, and recoverability.
//
// Responsibilities:
//     - Validate bundle structure, size, checksum, and asset entries
//     - Perform health checks and generate diagnostic reports
//     - Repair common bundle issues (offsets, orphaned assets, checksum drift)
//     - Optimize memory usage and detect compression/duplication inefficiencies
//
// Architecture:
//     - Partial class extension of AssetBundle
//     - Operates on bundle metadata, entries, and loaded asset cache
//     - Uses BundleValidationResult, BundleHealthReport, BundleRepairReport,
//       and BundleOptimizationReport from AssetBundle_Types.cs
//
// Integration Points:
//     - Used by AssetManager for runtime validation
//     - Used by AssetPipeline for post-build verification
//     - Used by diagnostics and snapshot systems for reporting
//
// Notes:
//     - All operations assume the bundle is already loaded
//     - Exceptions are thrown for invalid state (disposed or not loaded)
// ============================================================================
