// ============================================================================
// File Path: Engine/Resources/Manager/AssetManager_Enums.cs
// File: AssetManager_Enums.cs
// Program: AssetManager (Enums)
// Subsystem: Resources
//
// Purpose:
//     Defines enumeration types used throughout the AssetManager subsystem,
//     including asset loading priority levels and other classification enums
//     required by loader, registry, and validation components.
//
// Responsibilities:
