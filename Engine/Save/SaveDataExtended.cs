...
namespace SASZombieAssaultTD.Engine.Save
{
    ...
    public class SaveDataExtended : SaveData
    {
        ...
        public SaveDataExtended() : base()
        {
            ...
            DebugLogger.Log(DiagnosticLevel.Info, "INFO", "SaveDataExtended: Created with P120/P100 integration");
        }
        ...
        public void UpdateBattlefieldProgress(BattlefieldType battlefield, bool completed, int highestWave, int highScore)
        {
            ...
            DebugLogger.Log(DiagnosticLevel.Info, "INFO", $"SaveDataExtended: Updated {battlefield.GetDisplayName()} progress");
        }
        ...
        public void UnlockBattlefield(BattlefieldType battlefield)
        {
            ...
            DebugLogger.Log(DiagnosticLevel.Info, "INFO", $"SaveDataExtended: Unlocked battlefield {battlefield.GetDisplayName()}");
        }
        ...
        public void UpdateWaveProgress(int waveNumber, bool completed, int enemiesKilled, int championsDefeated, float timeTaken)
        {
            ...
            DebugLogger.Log(DiagnosticLevel.Info, "INFO", $"SaveDataExtended: Updated wave {waveNumber} progress");
        }
        ...
        public void ResetExtendedProgress()
        {
            ...
            DebugLogger.Log(DiagnosticLevel.Info, "INFO", "SaveDataExtended: Reset extended progress to defaults");
        }
