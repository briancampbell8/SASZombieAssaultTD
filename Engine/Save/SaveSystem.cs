...
{
    /// <summary>
    /// Save system for managing game save files. Implements SaveSystem with Write, Read, and Auto-Save functionality.
    /// </summary>
    public class SaveSystem
    {
        ...
        public SaveSystem(string? saveDirectory = null, string fileExtension = ".sav")
        {
            ...
            DLogger.Log(LogSubsystems.ResourcesPipeline, "INFO", $"SaveSystem initialized with directory '{_saveDirectory}'");
        }

        /// <summary>
        /// Writes save data to a specific slot. P20-10-02: Implements Write functionality.
        /// </summary>
        ...
        /// <summary>
        /// Reads save data from a specific slot. P20-10-02: Implements Read functionality.
        /// </summary>
        /// <param name="slot">The save slot (0-9).</param>
        ...
        /// <summary>
        /// Checks if a save version is compatible. P20-10-08: Add versioning for save files.
        /// </summary>
        ...
        private static void CaptureTowerState(GSCore save)
        {
            ...
            save.Towers = new TowerSaveData
            {
                ...
                TowerCount = towerUpgradeManager.GetUpgrades("default"),
        ...
        private void LogInfo(string message) => DLogger.Log(LogSubsystems.ResourcesPipeline, "INFO", $"SaveSystem: {message}");

        private void LogWarning(string message) => DLogger.Log(LogSubsystems.ResourcesPipeline, "WARNING", $"SaveSystem: {message}");

        private void HandleError(string context, Exception ex)
        {
            DLogger.Log(LogSubsystems.ResourcesPipeline, "ERROR", $"SaveSystem: {context} - {ex.Message}");
