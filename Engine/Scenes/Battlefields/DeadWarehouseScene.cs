...
namespace SASZombieAssaultTD.Engine.Scenes.Battlefields
{
    ...
    public class DeadWarehouseScene : BattlefieldScene
    {
        ...
        protected override void SetupSpawnNodes()
        {
            ...
            Engine.Diagnostics.DebugLogger.Log("Info", $"DeadWarehouseScene: Setup {SpawnNodes.Count} spawn nodes");
        }
        ...
        protected override void SetupExitNodes()
        {
            ...
            Engine.Diagnostics.DebugLogger.Log("Info", $"DeadWarehouseScene: Setup {ExitNodes.Count} exit nodes");
        }
        ...
        protected override void SetupCameraBounds()
        {
            ...
            Engine.Diagnostics.DebugLogger.Log("Info", $"DeadWarehouseScene: Camera bounds set to {CameraBoundsMin} to {CameraBoundsMax}");
        }
