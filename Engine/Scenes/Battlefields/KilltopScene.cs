...
namespace SASZombieAssaultTD.Engine.Scenes.Battlefields
{
    ...
    public class KilltopScene : BattlefieldScene
    {
        ...
        protected override void SetupSpawnNodes(object dlogger)
        {
            ...
            DLogger.Log("Info", $"KilltopScene: Setup {SpawnNodes.Count} spawn nodes (multi-directional)");
        }
        ...
        protected override void SetupExitNodes()
        {
            ...
            DLogger.Log("Info", $"KilltopScene: Setup {ExitNodes.Count} exit nodes");
        }
        ...
        protected override void SetupCameraBounds()
        {
            ...
            DLogger.Log("Info", $"KilltopScene: Camera bounds set to {CameraBoundsMin} to {CameraBoundsMax}");
        }
