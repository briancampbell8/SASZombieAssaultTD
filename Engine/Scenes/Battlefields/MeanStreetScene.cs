...
namespace SASZombieAssaultTD.Engine.Scenes.Battlefields
{
    ...
    public class MeanStreetScene : BattlefieldScene
    {
        ...
        protected override void SetupSpawnNodes()
        {
            ...
            Engine.Diagnostics.DebugLogger.Log("Info", $"MeanStreetScene: Setup {SpawnNodes.Count} spawn nodes");
        }
        ...
        protected override void SetupExitNodes()
        {
            ...
            Engine.Diagnostics.DebugLogger.Log("Info", $"MeanStreetScene: Setup {ExitNodes.Count} exit nodes");
        }
        ...
        protected override void SetupCameraBounds()
        {
            ...
            Engine.Diagnostics.DebugLogger.Log("Info", $"MeanStreetScene: Camera bounds set to {CameraBoundsMin} to {CameraBoundsMax}");
        }
