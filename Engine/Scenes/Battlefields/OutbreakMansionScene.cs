...
namespace SASZombieAssaultTD.Engine.Scenes.Battlefields
{
    ...
    public class OutbreakMansionScene : BattlefieldScene
    {
        ...
        protected override void SetupSpawnNodes(object dlogger)
        {
            ...
            DLogger.Log("Info", $"OutbreakMansionScene: Setup {SpawnNodes.Count} spawn nodes (final boss map)");
        }
        ...
        protected override void SetupExitNodes()
        {
            ...
            DLogger.Log("Info", $"OutbreakMansionScene: Setup {ExitNodes.Count} exit nodes");
        }
        ...
        protected override void SetupCameraBounds()
        {
            ...
            DLogger.Log("Info", $"OutbreakMansionScene: Camera bounds set to {CameraBoundsMin} to {CameraBoundsMax}");
        }
