...
namespace SASZombieAssaultTD.Engine.Scenes.Battlefields
{
    ...
    public class ShopTilYouDropScene : BattlefieldScene
    {
        ...
        protected override void SetupSpawnNodes(object dlogger)
        {
            ...
            DLogger.Log("Info", $"ShopTilYouDropScene: Setup {SpawnNodes.Count} spawn nodes");
        }
        ...
        protected override void SetupExitNodes()
        {
            ...
            DLogger.Log("Info", $"ShopTilYouDropScene: Setup {ExitNodes.Count} exit nodes");
        }
        ...
        protected override void SetupCameraBounds()
        {
            ...
            DLogger.Log("Info", $"ShopTilYouDropScene: Camera bounds set to {CameraBoundsMin} to {CameraBoundsMax}");
        }
