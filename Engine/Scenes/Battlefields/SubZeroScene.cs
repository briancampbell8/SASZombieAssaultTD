...
namespace SASZombieAssaultTD.Engine.Scenes.Battlefields
{
    ...
    public class SubZeroScene : BattlefieldScene
    {
        ...
        protected override void SetupSpawnNodes()
        {
            ...
            Engine.Diagnostics.DebugLogger.Log("Info", $"SubZeroScene: Setup {SpawnNodes.Count} spawn nodes");
        }
        ...
        protected override void SetupExitNodes()
        {
            ...
            Engine.Diagnostics.DebugLogger.Log("Info", $"SubZeroScene: Setup {ExitNodes.Count} exit nodes");
        }
        ...
        protected override void SetupCameraBounds()
        {
            ...
            Engine.Diagnostics.DebugLogger.Log("Info", $"SubZeroScene: Camera bounds set to {CameraBoundsMin} to {CameraBoundsMax}");
        }
