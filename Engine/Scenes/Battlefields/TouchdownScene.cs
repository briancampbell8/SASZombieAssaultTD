...
namespace SASZombieAssaultTD.Engine.Scenes.Battlefields
{
    ...
    public class TouchdownScene : BattlefieldScene
    {
        ...
        protected override void SetupSpawnNodes()
        {
            ...
            Engine.Diagnostics.DebugLogger.Log("Info", $"TouchdownScene: Setup {SpawnNodes.Count} spawn nodes (curved paths)");
        }
        ...
        protected override void SetupExitNodes()
        {
            ...
            Engine.Diagnostics.DebugLogger.Log("Info", $"TouchdownScene: Setup {ExitNodes.Count} exit nodes");
        }
        ...
        protected override void SetupCameraBounds()
        {
            ...
            Engine.Diagnostics.DebugLogger.Log("Info", $"TouchdownScene: Camera bounds set to {CameraBoundsMin} to {CameraBoundsMax}");
        }
