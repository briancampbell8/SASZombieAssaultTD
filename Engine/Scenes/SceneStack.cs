...
namespace SASZombieAssaultTD.Engine.Scenes
{
    ...
    public class SceneStack
    {
        ...
        public SceneStack()
        {
            ...
            Engine.Diagnostics.DebugLogger.Log("Info", "SceneStack: Initialized");
        }
        ...
        public void SetSceneManager(SceneManager sceneManager)
        {
            ...
            Engine.Diagnostics.DebugLogger.Log("Info", "SceneStack: SceneManager set");
        }
        ...
        public bool Push(BaseScene scene)
        {
            if (scene == null)
            {
                Engine.Diagnostics.DebugLogger.Log("Error", "SceneStack: Cannot push null scene");
                return false;
            }
            ...
            try
            {
                ...
                Engine.Diagnostics.DebugLogger.Log("Info", $"SceneStack: Pushed scene '{scene.GetType().Name}' (stack size: {_sceneStack.Count})");
            ...
            {
                Engine.Diagnostics.DebugLogger.Log("Error", $"SceneStack: Failed to push scene - {ex.Message}");
                return false;
            }
        }
        ...
        public bool Push(string sceneName)
        {
            ...
            {
                Engine.Diagnostics.DebugLogger.Log("Error", "SceneStack: Cannot push by name - SceneManager not set");
                return false;
            }
            ...
            if (scene == null)
            {
                Engine.Diagnostics.DebugLogger.Log("Error", $"SceneStack: Failed to load scene '{sceneName}'");
                return false;
            }
        ...
        public BaseScene? Pop()
        {
            if (_sceneStack.Count == 0)
            {
                Engine.Diagnostics.DebugLogger.Log("Warning", "SceneStack: Cannot pop from empty stack");
                return null;
            }
            ...
            try
            {
                ...
                Engine.Diagnostics.DebugLogger.Log("Info", $"SceneStack: Popped scene '{poppedScene.GetType().Name}' (stack size: {_sceneStack.Count})");
            ...
            {
                Engine.Diagnostics.DebugLogger.Log("Error", $"SceneStack: Failed to pop scene - {ex.Message}");
                return null;
            }
        }
        ...
        public BaseScene? Replace(BaseScene scene)
        {
            if (scene == null)
            {
                Engine.Diagnostics.DebugLogger.Log("Error", "SceneStack: Cannot replace with null scene");
                return null;
            }

            if (_sceneStack.Count == 0)
            {
                Engine.Diagnostics.DebugLogger.Log("Warning", "SceneStack: Cannot replace on empty stack, pushing instead");
                Push(scene);
                return null;
            }
            ...
            try
            {
                ...
                Engine.Diagnostics.DebugLogger.Log("Info", $"SceneStack: Replaced '{replacedScene.GetType().Name}' with '{scene.GetType().Name}'");
            ...
            {
                Engine.Diagnostics.DebugLogger.Log("Error", $"SceneStack: Failed to replace scene - {ex.Message}");
                return null;
            }
        }
        ...
        public BaseScene? Replace(string sceneName)
        {
            if (_sceneManager == null)
            {
                Engine.Diagnostics.DebugLogger.Log("Error", "SceneStack: Cannot replace by name - SceneManager not set");
                return null;
            }
        ...
        public void Clear()
        {
            if (_sceneStack.Count == 0)
            {
                Engine.Diagnostics.DebugLogger.Log("Warning", "SceneStack: Stack is already empty");
                return;
            }
            ...
            try
            {
                ...
                Engine.Diagnostics.DebugLogger.Log("Info", $"SceneStack: Cleared {count} scenes from stack");
            }
            catch (Exception ex)
            {
                Engine.Diagnostics.DebugLogger.Log("Error", $"SceneStack: Failed to clear stack - {ex.Message}");
            }
        }
