...
namespace SASZombieAssaultTD.Engine.State
{
    ...
    public class BootState : IGameState
    {
        ...
        public void Enter()
        {
            DLogger.Log(LogSubsystems.State, LogLevel.Info, "INFO", "BootState: Entered - Starting resource loading");
            _resourcesLoaded = false;
        ...
        public void Exit()
        {
            DLogger.Log(LogSubsystems.State, LogLevel.Info, "INFO", "BootState: Exited - Resource loading complete");
        }
        ...
        public void Update(float deltaTime)
        {
            ...
            if (_resourcesLoaded)
            {
                DLogger.Log(LogSubsystems.State, LogLevel.Info, "INFO", "BootState: Resources loaded, transitioning to MainMenu");
        ...
        public void HandleEvent(GameEvent gameEvent)
        {
            ...
            DLogger.Log(LogSubsystems.Unknown, LogLevel.Info, "DEBUG", $"BootState: Ignoring event {gameEvent.GetType().Name} during boot");
        }
        ...
        {
            DLogger.Log(LogSubsystems.State, LogLevel.Info, "INFO", "BootState: Loading core resources...");
            ...
            _resourcesLoaded = true;
            DLogger.Log(LogSubsystems.State, LogLevel.Info, "INFO", "BootState: Core resources loaded successfully");
        }
    }
}
