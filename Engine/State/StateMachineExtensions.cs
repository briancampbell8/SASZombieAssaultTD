    ...
    public static class StateMachineExtensions
    {
        ...
        public static bool TryChangeState(this StateMachine stateMachine, GameStateType targetState, GameEvent? triggerEvent = null)
        {
            try
            {
                ...
                {
                    DLogger.Log(LogSubsystems.Unknown, LogLevel.Info, "WARNING", $"StateMachine: Transition disallowed - {StateTransitionRules.GetValidationMessage(stateMachine.CurrentStateType, targetState)}");
                    return false;
                }
            ...
            {
DLogger.Log(LogSubsystems.State,LogLevel.Info,"ERROR",$"StateMachine: Transition failed - {ex.Message}");
                return false;
            }
        }
