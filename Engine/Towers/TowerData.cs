...
//
//  ROLE:
//      Encapsulate core engine behavior for the TowerData module.
//
//  RESPONSIBILITIES:
...
namespace SASZombieAssaultTD.Engine.Towers
{
    ...
    /// <summary>
    /// Core data structure for tower definitions. Contains all tower properties required for gameplay and validation.
    /// </summary>
    public class TowerData
    {
        ...
        public object UpgradeType { get; internal set; }
        ...
        public TowerData(string towerId) => TowerId = towerId ?? throw new ArgumentNullException(nameof(towerId));
        ...
        internal class Builder : TowerData
        {
            ...
            public Builder(TowerType towerType) : base(towerType.ToString()) => this.towerType = towerType;
