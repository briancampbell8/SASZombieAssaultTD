...
{
    /// <summary>
    /// Background renderer for main menu and game states. Handles animated backgrounds with parallax scrolling and
    /// transitions.
    /// </summary>
    public class BackgroundRenderer
    {
        ...
        public void Initialize(string backgroundName)
        {
            ...
            {
                DLogger.Log(LogSubsystems.Rendering, LogEnums.LogLevel.Error, "BackgroundRenderer: Background name cannot be null or empty");
                return;
            }
            ...
            DLogger.Log(LogSubsystems.Rendering, LogEnums.LogLevel.Debug, $"BackgroundRenderer: Initialized background '{backgroundName}'");
        }
        ...
        public void Start()
        {
            if (!_isInitialized)
            {
                DLogger.Log(LogSubsystems.Rendering, LogEnums.LogLevel.Warning, "BackgroundRenderer: Cannot start - not initialized");
                return;
            }
            ...
            DLogger.Log(LogSubsystems.Rendering, LogEnums.LogLevel.Debug, $"BackgroundRenderer: Started background '{BackgroundName}'");
        }
        ...
        public void Stop()
        {
            ...
            DLogger.Log(LogSubsystems.Rendering, LogEnums.LogLevel.Debug, $"BackgroundRenderer: Stopped background '{BackgroundName}'");
        }
        ...
        private void UpdateBackgroundAnimation(float deltaTime)
        {
            ...
            BackgroundColor = new Color(
                (byte)(baseColor.R * pulse),
                (byte)(baseColor.G * pulse),
                (byte)(baseColor.B * pulse)
            );
        }
        ...
        public void Render()
        {
            ...
            {
                DLogger.Log(LogSubsystems.Rendering, LogEnums.LogLevel.Error, $"BackgroundRenderer: Failed to render background '{BackgroundName}': {ex.Message}");
            }
        }
        ...
        private void RenderBackground()
        {
            ...
            DLogger.Log(LogSubsystems.Rendering, LogEnums.LogLevel.Debug, $"BackgroundRenderer: Rendering background '{BackgroundName}' with color {BackgroundColor}");
        }
        ...
        public void TransitionToColor(Color targetColor, float duration = 1.0f)
        {
            ...
            DLogger.Log(LogSubsystems.Rendering, LogEnums.LogLevel.Debug, $"BackgroundRenderer: Starting color transition to {targetColor} over {duration}s");
        }
