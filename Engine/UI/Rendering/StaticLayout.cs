...
{
    ///<summary>
    ///Data model for static UI and map layout definitions.
    ///Loaded from JSON configuration files.
    ///</summary>
    public sealed class StaticLayout
    {
        public List<StaticImageEntry> Images { get; set; } = new();
    }

    ///<summary>
    ///Individual static image entry with position, size, and layer information.
    ///</summary>
    public sealed class StaticImageEntry
    {
