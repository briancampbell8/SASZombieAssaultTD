...
//
{
    ...
    public class UISystem
    {
        ...
        public bool IsVisible
        {
            ...
            {
                _isVisible = value;
                DLogger.Log(LogSubsystems.UI, LogLevel.Info, $"UI System visibility set to: {value}");
            }
        }
        ...
        public bool InputEnabled
        {
            ...
            {
                _inputEnabled = value;
                DLogger.Log(LogSubsystems.UI, LogLevel.Info, $"UI input enabled set to: {value}");
            }
        }
        ...
        public void Initialize(int screenWidth, int screenHeight)
        {
            if (_initialized)
            {
                DLogger.Log("UI System already initialized");
                return;
            }
            ...
            {
                DLogger.Log(ex.ToString(), "Failed to initialize UI System");
                throw;
            }
        }
        ...
        public void Update(float deltaTime)
        {
            ...
            {
                DLogger.Log(ex.ToString(), "Failed to update UI System");
            }
        }
        ...
        public void Render(UIRenderContext renderContext)
        {
            ...
            {
                DLogger.Log(ex.ToString(), "Failed to render UI System");
            }
        }
        ...
        public void AddElement(UIElement element)
        {
            if (element == null)
            {
                DLogger.Log("Attempted to add null UI element");
                return;
            }
        ...
        public void RemoveElement(UIElement element)
        {
            ...
            {
                element.Cleanup();
                DLogger.Log($"Removed UI element: {element.Name}");
            }
        }
        ...
        public void AddPanel(UIPanel panel)
        {
            if (panel == null)
            {
                DLogger.Log("Attempted to add null UI panel");
                return;
            }
        ...
        public void HandleInput(UIInputState inputEvent, object elementX)
        {
            ...
            {
                DLogger.Log(ex.ToString(), "Failed to handle UI input");
            }
        }
        ...
        public void Shutdown()
        {
            ...
            Clear();
            _initialized = false;
            DLogger.Log("UI System shutdown");
        }
